document.addEventListener('alpine:init', () => {
    Alpine.data('search', () => ({
        ...
        sections: [
            ...
            { name: 'Trainee', route: '/students', icon: 'users' },
            { name: 'Staff', route: '/staff', icon: 'users' },
            { name: 'Rooms', route: '/rooms', icon: 'office-building' },
            { name: 'Stock', route: '/stock', icon: 'cube' },
            { name: 'Suppliers', route: '/suppliers', icon: 'truck' },
            { name: 'Payments', route: '/payments', icon: 'cash' },
            { name: 'Reports', route: '/reports', icon: 'chart-bar' },
