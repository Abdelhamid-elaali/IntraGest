            ...
            <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="url" class="form-control @error('website') is-invalid @enderror" id="website" name="website" value="{{ old('website', $supplier->website) }}" placeholder="https://">
                        @error('website')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('suppliers.show', $supplier->id) }}" class="btn btn-secondary ms-2">
