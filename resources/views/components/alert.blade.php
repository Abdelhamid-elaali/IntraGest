...
<div {{ $attributes->merge(['class' => "{$types[$type]['bg']} p-4 rounded-md"]) }} role="alert">
    <div class="flex">
        ...
        @if($dismissible)
            <div class="ml-auto pl-3">
                <div class="-mx-1.5 -my-1.5">
                    <button type="button" class="{{ $types[$type]['text'] }} rounded-md p-1.5 hover:bg-opacity-20 hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-{{ substr($types[$type]['bg'], 3) }} focus:ring-{{ substr($types[$type]['text'], 5) }}" onclick="this.parentElement.parentElement.parentElement.parentElement.remove()">
