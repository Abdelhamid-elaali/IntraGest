...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6 h-screen">
    ...
    <div class="bg-white rounded-lg shadow lg:col-span-2 mb-6 max-h-[calc(100vh-100px)] overflow-auto">
        ...
        <div class="p-4">
            @if($recentTransactions->isEmpty())
                <div class="text-center py-6 bg-gray-50 rounded-lg">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('stocks.create') }}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200">
