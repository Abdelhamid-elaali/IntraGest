...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Edit Room</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="pavilion" id="pavilion" required
                        ...
                        <option value="Girls" {{ old('pavilion', $room->pavilion) == 'Girls' ? 'selected' : '' }}>Girls</option>
                        <option value="Boys" {{ old('pavilion', $room->pavilion) == 'Boys' ? 'selected' : '' }}>Boys</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="accommodation_type" id="accommodation_type" required
                        ...
                        <option value="Personal" {{ old('accommodation_type', $room->accommodation_type) == 'Personal' ? 'selected' : '' }}>Personal</option>
                        <option value="Shared" {{ old('accommodation_type', $room->accommodation_type) == 'Shared' ? 'selected' : '' }}>Shared</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="description" id="description"
                        ...
                        <option value="Occupied - Reservable" {{ old('description', $room->description) == 'Occupied - Reservable' ? 'selected' : '' }}>Occupied - Reservable</option>
                        <option value="Vacant - Trainees" {{ old('description', $room->description) == 'Vacant - Trainees' ? 'selected' : '' }}>Vacant - Trainees</option>
                    </select>
                </div>
            </div>
