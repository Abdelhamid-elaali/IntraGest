...
<div class="container-fluid px-4">
    <h1 class="mt-4">Create Stock Order</h1>
        ...
        <div class="card-body">
            <form action="{{ route('stock-orders.store') }}" method="POST" id="orderForm">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('order_number') is-invalid @enderror" id="order_number" name="order_number" value="{{ old('order_number', 'PO-' . date('Ymd') . '-' . str_pad(rand(1, 999), 3, '0', STR_PAD_LEFT)) }}" required>
                                    @error('order_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Auto-generated, you can modify if needed</small>
                                </div>
                                ...
                                <tbody id="itemsTableBody">
                                    ...
                                    @if(old('items'))
                                        @foreach(old('items') as $index => $item)
                                            <tr class="item-row">
                                                <td>
                                                    <select class="form-select item-select" name="items[{{ $index }}][stock_id]" required>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control item-unit" name="items[{{ $index }}][unit_type]" value="{{ $item['unit_type'] }}" required>
                                                </td>
                                                <td>
                                                    <input type="number" step="0.01" class="form-control item-price" name="items[{{ $index }}][unit_price]" value="{{ $item['unit_price'] }}" min="0.01" required>
                                                </td>
                                                <td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th colspan="4" class="text-end">
                                            Tax Rate (%):
                                            <input type="number" step="0.01" class="form-control form-control-sm d-inline-block" style="width: 80px;" id="taxRate" name="tax_rate" value="{{ old('tax_rate', 0) }}" min="0" max="100">
                                        </th>
                                        <th colspan="2">
                                    ...
                                    <tr>
                                        <th colspan="4" class="text-end">
                                            Discount:
                                            <input type="number" step="0.01" class="form-control form-control-sm d-inline-block" style="width: 80px;" id="discountAmount" name="discount_amount" value="{{ old('discount_amount', 0) }}" min="0">
                                        </th>
                                        <th colspan="2">
                                    ...
                                    <tr>
                                        <th colspan="4" class="text-end">
                                            Shipping:
                                            <input type="number" step="0.01" class="form-control form-control-sm d-inline-block" style="width: 80px;" id="shippingAmount" name="shipping_amount" value="{{ old('shipping_amount', 0) }}" min="0">
                                        </th>
                                        <th colspan="2">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('stock-orders.index') }}" class="btn btn-secondary me-2">Cancel</a>
