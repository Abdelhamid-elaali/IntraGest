                ...
                <form action="{{ route('profile.password.update') }}" method="POST" class="space-y-5 bg-gray-50 p-5 rounded-lg shadow-sm" x-data="{
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pt-6">
                            <button type="button" @click="togglePasswordVisibility('current_password')" class="text-gray-400 hover:text-gray-600 focus:outline-none">
                                <svg x-show="!passwordVisible.current_password" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" placeholder="Enter new password" required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 pl-3 pr-10 py-2">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pt-6">
                            <button type="button" @click="togglePasswordVisibility('password')" class="text-gray-400 hover:text-gray-600 focus:outline-none">
                                <svg x-show="!passwordVisible.password" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                                <svg x-show="passwordVisible.password" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm new password" required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 pl-3 pr-10 py-2">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pt-6">
                            <button type="button" @click="togglePasswordVisibility('password_confirmation')" class="text-gray-400 hover:text-gray-600 focus:outline-none">
                                <svg x-show="!passwordVisible.password_confirmation" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                                <svg x-show="passwordVisible.password_confirmation" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
